...
export const createProduct = mutation({
  args: {
    ...
    paymentOptions: v.optional(v.object({ mode: v.string(), percent: v.optional(v.number()), acceptedModes: v.optional(v.array(v.string())) })),
...
export const updateProduct = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    const patch: Record<string, unknown> = {
      ...
      deliveryPeriod: args.deliveryPeriod !== undefined ? args.deliveryPeriod : (product as any).deliveryPeriod,
      deliveryNotes: args.deliveryNotes !== undefined ? args.deliveryNotes : (product as any).deliveryNotes,
